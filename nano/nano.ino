...
void loop() {
  ...
  if (millis() - lastDebugMs >= 2000) {
    ...
    Serial.println("------------------------------------------");
    Serial.print("Jarak  : ");
    Serial.print(bacaUS(ECHO_S1)); Serial.print("cm | ");
    Serial.print(bacaUS(ECHO_S2)); Serial.print("cm | ");
    Serial.print(bacaUS(ECHO_S3)); Serial.print("cm | ");
    Serial.print(bacaUS(ECHO_S4)); Serial.println("cm");
